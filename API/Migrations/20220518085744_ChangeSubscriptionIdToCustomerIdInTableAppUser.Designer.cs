...
namespace API.Migrations
{
    ...
    [Migration("20220518085744_ChangeSubscriptionIdToCustomerIdInTableAppUser")]
    partial class ChangeSubscriptionIdToCustomerIdInTableAppUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.CourseEnrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.LectureActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.UserSession", b =>
                {
                    b.HasOne("API.Entities.AppUser", "AppUser")
                        .WithOne("UserSession")
                        .HasForeignKey("API.Entities.UserSession", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Entities.Lecture", b =>
                {
                    b.Navigation("LectureActivities");
                });
